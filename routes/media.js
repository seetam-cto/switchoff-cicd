...
import { getMedia, uploadMedia, getPrivateMedia, getSpecificMedia, uploadPropertyMedia, directUpload } from "../controllers/media"
...
router.post("/media/direct/upload", requireSignIn, upload.single("media"), directUpload)
